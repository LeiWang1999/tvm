                      ...
                      for (j: int32, 0, 16) {
                        for (k: int32, 0, 16) {
                          block([1024, 1024, tir.reduce_axis(0, 1024), 16, 16, tir.reduce_axis(0, 16)], "B") as [vii, vjj, vkk, vi, vj, vk] {
                            ...
                            C_warp[vii, vjj, vi, vj] = (C_warp[vii, vjj, vi, vj] + (cast(float32, A_shared_warp[vii, vkk, vi, vk])*cast(float32, B_shared_warp[vjj, vkk, vj, vk])))
                        }
                      }
                    }
                  }
