                        ...
                        for kk_1 in T.serial(2):
                            ...
                            for ii_2, jj_2, i, j, k in T.grid(4, 4, 16, 16, 16):
                                with T.block("B_update"):
                                    ...
                                    C_warp[vii, vjj, vi % 8 * 4 + vj % 8 // 2, vj // 8 * 4 + vi // 8 * 2 + vj % 2] = C_warp[vii, vjj, vi % 8 * 4 + vj % 8 // 2, vj // 8 * 4 + vi // 8 * 2 + vj % 2] + T.Cast("float32", A_shared_warp[vii, vkk, vi * 2 + vk // 8, vk % 8]) * T.Cast("float32", B_shared_warp[vjj, vkk, vj * 2 + vk // 8, vk % 8])
