...
def func(A: T.Buffer[(1024, 1024, 16, 16), "float16"], B: T.Buffer[(1024, 1024, 16, 16), "float16"], C: T.Buffer[(1024, 1024, 16, 16), "float32"]):
    ...
    C_warp = T.alloc_buffer([1024, 1024, 16, 16], dtype="float32", scope="warp")
                        ...
                        for kk_1 in T.serial(2):
                            ...
                            for ii_2, jj_2, i, j, k in T.grid(4, 4, 16, 16, 16):
                                with T.block("B_update"):
                                    ...
                                    T.writes(C_warp[vii, vjj, vi, vj])
                                    C_warp[vii, vjj, vi, vj] = C_warp[vii, vjj, vi, vj] + T.Cast("float32", A_shared_warp[vii, vkk, vi, vk]) * T.Cast("float32", B_shared_warp[vjj, vkk, vj, vk])
