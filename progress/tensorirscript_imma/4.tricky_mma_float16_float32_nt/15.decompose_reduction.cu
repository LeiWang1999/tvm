...
@main = primfn(a: handle, b: handle, c: handle) -> ()
  ...
  block([], "root") {
    ...
    C_warp = alloc_buffer(float32[1024, 1024, 16, 16])
                      ...
                      for (j: int32, 0, 16) {
                        for (k: int32, 0, 16) {
                          block([1024, 1024, tir.reduce_axis(0, 1024), 16, 16, tir.reduce_axis(0, 16)], "B_update") as [vii_1, vjj_1, vkk, vi_1, vj_1, vk] {
                            ...
                            C_warp[vii_1, vjj_1, vi_1, vj_1] = (C_warp[vii_1, vjj_1, vi_1, vj_1] + (cast(float32, A_shared_warp[vii_1, vkk, vi_1, vk])*cast(float32, B_shared_warp[vjj_1, vkk, vj_1, vk])))
                        }
                      }
                    }
                  }
